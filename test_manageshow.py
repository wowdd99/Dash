...
class TestUser:
    ...
    def test_ms_0001(self, browser):
        link = "http://10.94.6.100:50000/Home/Homepage"
        page = MainPage(browser, link)
        page.open()
        page.should_open_manage_show_page()
        time.sleep(15)
        manage_page = ManageShowPage(browser, link)
    ...
    def test_ms_0020(self, browser):
        ...
        link = "http://10.94.6.100:50000/ones/shows/add-edit"
        create_page = CreateShowPage(browser, link)
        create_page.open()
        time.sleep(15)
    ...
    def test_ms_0026(self,browser):
        ...
        manage_page.open_create_show_page()
        manage_page.check_the_input_in_the_code_field_that_was_privios_removed()
        manage_page.check_the_input_in_the_show_color_field()
        manage_page.check_the_input_in_the_actual_category_field()
        manage_page.check_the_input_in_the_planning_category_field()
        manage_page.check_the_input_in_the_amount_of_assets_field()
        manage_page.check_the_input_in_the_amount_of_shots_field()
        manage_page.check_the_input_in_the_start_date_field()
        manage_page.check_the_input_in_the_end_date_field()
        manage_page.check_the_input_in_the_seniority_splits_section()
        manage_page.check_the_input_in_the_show_currency_field()
        manage_page.check_the_input_in_the_awards_est_field()
        manage_page.check_the_input_in_the_primary_field()
        manage_page.check_switch_to_show_input_tab()
        manage_page.check_the_input_in_the_adelaide_field()
        manage_page.check_the_input_in_the_primary_producer_field()
    ...
    def test_ms_0029(self, browser):
        ...
        manage_page = ManageShowPage(browser, link)
        manage_page.open_create_show_page()
        manage_page.check_the_input_in_the_code_field()
        manage_page.check_the_input_in_the_show_color_field()
        manage_page.check_the_input_in_the_actual_category_field()
        manage_page.check_the_input_in_the_planning_category_field()
        manage_page.check_the_input_in_the_amount_of_assets_field()
