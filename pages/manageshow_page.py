...
class ManageShowPage(BasePage):
    ...
    # исправить индекс на переменную "+index+"
        ...
        print(show_code_after_split)
        print(show_name_after_split)
    ...
    def should_be_correct_result_after_search(self):
        ...
        for i in range(1, len(show_cards_list)+1):
            ...
            show_card.find(show_code_after_split)
    ...
    def verify_that_show_code_is_pre_selected(self):
        ...
        show_code_after_split.find(show_code_in_ones), f"Show code doesn't match"
    ...
    def should_be_financial_interface_for_relevant_show(self):
        ...
        print(url_new_after_split)
        show_code_after_split.find(url_new_after_split), f"Page isn't relevant"

    def verify_show_stats_tab_display(self):
        show_stats_tab = self.browser.find_element(*ManageShowLocators.SHOW_STATS_TAB)
        assert show_stats_tab, "Show Stat tab isn't dispayed/default tab"
    ...
    def check_the_input_in_the_code_field_that_was_privios_removed(self):
    ...
    def check_the_input_in_the_code_field(self):
        show_code_input = self.browser.find_element(*ManageShowLocators.SHOW_CODE_FIELD)
        show_code_input.click()
        show_code_input_text = self.browser.find_element(*CreateNewShowLocators.INPUT)
    ...
    def check_the_input_in_the_show_color_field(self):
    ...
    def check_the_input_in_the_actual_category_field(self):
    ...
    def check_the_input_in_the_planning_category_field(self):
    ...
    def check_the_input_in_the_amount_of_assets_field(self):
        ...
        amount_of_assert_input.send_keys('55')
        time.sleep(3)

    def check_the_input_in_the_amount_of_shots_field(self):
        ...
        amount_of_shorts_input.send_keys('55')
        time.sleep(3)

    def check_the_input_in_the_start_date_field(self):
    ...
    def check_the_input_in_the_end_date_field(self):
        end_day_calendar = self.browser.find_element(*CreateNewShowLocators.END_DATE_FIELD)
        end_day_calendar.click()
        self.clicking_on_today_day_from_calendar()
        self.clicking_on_confirm_btn()

    def check_the_input_in_the_seniority_splits_section(self):
        ...
        key_artist_input.send_keys(int('10'))
        time.sleep(2)
        ...
        supervisor_input.send_keys(int('10'))
        time.sleep(2)

    def check_the_input_in_the_show_currency_field(self):
    ...
    def check_the_input_in_the_awards_est_field(self):
        ...
        awards_est_input.send_keys(40)
        time.sleep(3)

    def check_the_input_in_the_primary_field(self):
    ...
    def check_the_input_in_the_primary_producer_field(self):
    ...
    def check_success_cart_creation(self):
        ...
        search_field_input.send_keys(show_code_field)
        self.change_status_to_inactive()
        self.verify_only_one_card_displaying()
        show_code_and_name = self.browser.find_element(*ManageShowLocators.SHOW_CODE_AND_NAME).get_attribute("innerText")
        show_code_and_name.find(show_code_field)
        time.sleep(5)

    def check_success_cart_creation_new(self):
        search_field_input = self.browser.find_element(*ManageShowLocators.SEARCH_FIELD_INPUT)
        search_field_input.send_keys(show_code_random)
        self.change_status_to_inactive()
        self.verify_only_one_card_displaying()
        show_code_and_name = self.browser.find_element(*ManageShowLocators.SHOW_CODE_AND_NAME).get_attribute("innerText")
        show_code_and_name.find(show_code_random_str)
        time.sleep(5)
